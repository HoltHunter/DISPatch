...
constexpr int StopFreezeReasonOffset = 32;
...
constexpr int ThemeComboWidth = 180;
constexpr int IdentityStretchColumn = 5;
constexpr int TestFederateMinimumWidth = 520;
constexpr int TestFederateStretchColumn = 5;
constexpr int ResponseTableColumnCount = 6;
constexpr int MaxMessageRows = 1000;
constexpr int MaxLogBlocks = 1000;
constexpr int MaxTrackedRequests = 1000;
...
constexpr int HeartbeatPulseDurationMilliseconds = 450;
constexpr int HeartbeatIconExtent = 40;
